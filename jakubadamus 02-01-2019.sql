...
--
-- Host: 127.0.0.1
-- Czas generowania: 02 Sty 2019, 17:59
...
CREATE TABLE `uczniowie` (
  ...
  `uczen_object` text COLLATE latin1_general_ci NOT NULL,
  `wartosc_postaci` float NOT NULL,
  `spendable_coins` float NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(1, 'technikum_kreatywne', 'Jakub', 'Adamus', 2, 163.5, '{\"base\":0,\"helmet\":0,\"torso\":0,\"gloves\":0,\"pants\":0,\"boots\":0,\"weapon\":\"3\"}', 50, 113.5),
...
--
ALTER TABLE `uczniowie`
  MODIFY `uczen_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
